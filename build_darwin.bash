...
# make clean && make 
cmake -DCMAKE_CXX_COMPILER=/opt/homebrew/Cellar/llvm/18.1.5/bin/clang++ -DCMAKE_LD_COMPILER=/opt/homebrew/Cellar/llvm/18.1.5/bin/clang++ /path/to/your/source/code
cmake -S . -B build
cmake --build build